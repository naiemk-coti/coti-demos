...
/**
 * @param {{ sepoliaInboxAddress: string; sepoliaRpcUrl: string; cotiInboxAddress?: string; cotiRpcUrl?: string }} p
 * @returns {PodRequest}
 */
export function createMillionairePodRequest(p) {
    ...
    return new PodRequest({
        chains: [
            { chainId: SEPOLIA_CHAIN_ID, inboxAddress: p.sepoliaInboxAddress, rpcUrl: p.sepoliaRpcUrl },
