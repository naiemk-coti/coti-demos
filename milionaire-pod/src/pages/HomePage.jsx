...
function HomePage() {
    ...
    return (
        <AppContainer style={{ justifyContent: 'flex-start', paddingTop: '0' }}>
                    ...
                    <ModalContent onClick={(e) => e.stopPropagation()}>
                        ...
                        <InfoBox>
                            ...
                            <List>
                                ...
                                <ListItem>
                                    <strong>Step 5:</strong> The app waits until the MPC result is ready (a few minutes), then each party decrypts their result using their AES key to learn who is richer
                                </ListItem>
                                <ListItem>
            ...
            {/* Waiting for comparison results - spinner and message */}
            {waitingForResults && (
            ...
            <CardsContainer style={{ marginTop: '0', marginBottom: '2rem', maxWidth: '900px' }}>
                ...
                <Card $maxWidth="100%" style={{ padding: '1.5rem', marginBottom: '0', textAlign: 'center' }}>
                    ...
                    <HeaderContract>
                        <Link
                            href={`https://sepolia.etherscan.io/address/${contractAddress || '0x...'}`}
                            target="_blank"
                        ...
                        <Card $maxWidth="100%" style={{ padding: '1.5rem' }}>
                            <PlayerHeader>
                                <PlayerAddress>
                                    {bobWallet?.address ? (
                                        <Link
                                            href={`https://sepolia.etherscan.io/address/${bobWallet.address}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        >
                                            Bob:
                        ...
                        <Card $maxWidth="100%" style={{ padding: '1.5rem' }}>
                            <PlayerHeader>
                                <PlayerAddress>
                                    {aliceWallet?.address ? (
                                        <Link
                                            href={`https://sepolia.etherscan.io/address/${aliceWallet.address}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        >
                                            Alice:
